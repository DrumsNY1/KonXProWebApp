...
{
    public partial class EditBlogFeedSource
    {
        [Inject]
        ...
        {
            blogFeedSource = await db_9f8bee_konxdevService.GetBlogFeedSourceByFeedId(FeedId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_9f8bee_konxdevService.UpdateBlogFeedSource(FeedId, blogFeedSource);
