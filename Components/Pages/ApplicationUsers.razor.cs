...
namespace KonXProWebApp.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<KonXProWebApp.Models.ApplicationUser> users;
        protected RadzenDataGrid<KonXProWebApp.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(KonXProWebApp.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(KonXProWebApp.Models.ApplicationUser user)
        {
            try
            {
