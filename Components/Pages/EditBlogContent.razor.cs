...
{
    public partial class EditBlogContent
    {
        [Inject]
        ...
        {
            blogContent = await db_9f8bee_konxdevService.GetBlogContentByContentId(ContentId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_9f8bee_konxdevService.UpdateBlogContent(ContentId, blogContent);
