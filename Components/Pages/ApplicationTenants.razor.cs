...
namespace KonXProWebApp.Components.Pages
{
    public partial class ApplicationTenants
    {
        ...
        protected IEnumerable<KonXProWebApp.Models.ApplicationTenant> tenants;
        protected RadzenDataGrid<KonXProWebApp.Models.ApplicationTenant> grid0;
        ...
        protected async Task SetDefaultTenant(MouseEventArgs args, KonXProWebApp.Models.ApplicationTenant tenant)
        {
            Security.Tenant = tenant;
        }

        protected async Task RowSelect(KonXProWebApp.Models.ApplicationTenant tenant)
        {
        ...
        protected async void RowRender(RowRenderEventArgs<KonXProWebApp.Models.ApplicationTenant> args)
        {
            args.Attributes.Add("style", $"font-weight: {(args.Data.Id == Security.Tenant?.Id ? "bold" : "normal")};");
        }

        protected async Task DeleteClick(KonXProWebApp.Models.ApplicationTenant tenant)
        {
            try
            {
